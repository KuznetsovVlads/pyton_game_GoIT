...
player_size = (80, 40)
player = pygame.transform.scale(pygame.image.load('./img/player.png').convert_alpha(), (80, 40))
...
def create_enemy():
    enemy_size = (60, 20)
    enemy = pygame.transform.scale(pygame.image.load('./img/enemy.png').convert_alpha(), (90, 30))
...
def create_bonus():
    bonus_size = (60, 90)
    bonus = pygame.transform.scale(pygame.image.load('./img/bonus.png').convert_alpha(), (60, 90)) 
